...
/* harmony import */ var _inputs_inputs_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./inputs/inputs.component */ "./src/app/inputs/inputs.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _inputs_inputs_component__WEBPACK_IMPORTED_MODULE_3__["InputsComponent"],
...
module.exports = "<div class=\"mdl-card mdl-shadow--2dp data-cards\" id=\"line-chart\">\n  <!-- <div *ngIf=\"chartShown\"> -->\n  <canvas id=\"canvas\">{{ chart }}</canvas>\n  <!-- </div> -->\n</div>\n\n<div class=\"mdl-card mdl-shadow--2dp data-cards\">\n  <div id=\"table-responsive\">\n    <table *ngIf=\"data\" class=\"mdl-data-table mdl-js-data-table  mdl-shadow--2dp data-table\" id=\"my-table\">\n      <thead class=\"data-table\">\n        <tr>\n          <th class=\"mdl-data-table__cell--non-numeric data-table\">Period</th>\n          <th class=\"data-table\" *ngFor=\"let header of columns\">{{header}}</th>\n        </tr>\n      </thead>\n      <tbody>\n        <tr *ngFor=\"let value of data; let last = last; let i = index\">\n          <td class=\"mdl-data-table__cell--non-numeric\">{{value.Period}}</td>\n          <td [id]=\"i +'x' + i2\" class=\"editable-cell\" contenteditable *ngFor=\"let header of columns; let i2 = index\" (keypress)=\"editCell(this, $event)\">\n            {{value[header]}}\n          </td>\n          <!-- <span *ngIf=\"last\">{{tableCallback()}}</span> -->\n        </tr>\n      </tbody>\n    </table>\n  </div>\n</div>\n\n<button (click)=\"saveCsv()\" class=\"mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored\" id=\"fab\">\n  <i class=\"material-icons\">save</i>\n</button>"
...
var ChartComponent = /** @class */ (function () {
    function ChartComponent(dataService) {
        ...
        this.dataService.componentMethodCalled$.subscribe(function () {
            _this.newData = _this.dataService.filteredData;
            _this.populateCharts();
        });
    }
    ...
    ChartComponent.prototype.populateCharts = function () {
        $('.data-cards').css('display', 'block');
        $('#fab').css('display', 'block');
        var a = this.newData;
        this.data = a;
        this.chart.destroy();
        var columns = this.dataService.selectedColumns;
        this.columns = columns;
        var dates = a.map(function (a) { return new Date(a.Period); });
        this.dates = dates;
        var ydata = [];
        for (var i = 0; i < columns.length; i++) {
            ...
            dataParameters["data"] = a.map(function (a) { return parseInt(a[columns[i]]); });
    ...
    ChartComponent.prototype.isDataValid = function (data) {
        return isNaN(+data);
    };
    ChartComponent.prototype.saveCsv = function () {
...
var DataService = /** @class */ (function () {
    function DataService() {
        ...
        this.componentMethodCallSource = new rxjs_Subject__WEBPACK_IMPORTED_MODULE_1__["Subject"]();
        // Observable string streams
        this.componentMethodCalled$ = this.componentMethodCallSource.asObservable();
    }
    // Service message commands
    DataService.prototype.callComponentMethod = function () {
        this.componentMethodCallSource.next();
    };
    DataService.prototype.upload = function (csv, filename) {
        this.file = csv;
        // Parse CSV
    ...
    DataService.prototype.cleanData = function () {
        // Remove Invalid Data
        var dates = [];
    ...
    |-------------------------------------------------------------------------*/
    DataService.prototype.sortByDateAscending = function (a, b) {
        return a.Period - b.Period;
    };
    DataService.prototype.applyToggles = function () {
        var selectedColumns = $('#select-toggle').val();
        this.selectedColumns = selectedColumns;
        // Date Filter
        var startDate = new Date($('#start-date').val());
        var endDate = new Date($('#end-date').val());
        var dates = this.data.map(function (a) { return "" + a.Period; });
    ...
    DataService.prototype.saveCsv = function () {
        var options = {
            headers: ['Period'].concat(this.columns)
        };
        new angular5_csv_Angular5_csv__WEBPACK_IMPORTED_MODULE_2__["Angular5Csv"](this.data, 'Export', options);
    };
...
var InputsComponent = /** @class */ (function () {
    function InputsComponent(dataService) {
        this.dataService = dataService;
    }
    ...
    InputsComponent.prototype.newDate = function (date) {
...
module.exports = __webpack_require__(/*! /Users/hmmm/Documents/GitHub/csv-reader-2/csv/src/main.ts */"./src/main.ts");
